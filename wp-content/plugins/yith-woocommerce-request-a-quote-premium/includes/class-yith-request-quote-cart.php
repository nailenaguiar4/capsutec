	...
	class YITH_YWRAQ_Cart {
		...
		public function show_button_on_cart(  ) {
			...
			if ( 'button' === $button_style ) {
				echo wp_kses_post( apply_filters( 'ywraq_quote_button_checkout_html', '<button type="submit" class="button alt" id="ywraq_cart_quote" value="' . esc_attr( $label_button ) . '" data-value="' . esc_attr( $label_button ) . '">' . esc_html( $label_button ) . '</button>' ) );
			} else {
				echo wp_kses_post( apply_filters( 'ywraq_quote_button_checkout_html', '<a href="#" class="quote-button alt" id="ywraq_cart_quote" data-value="' . esc_attr( $label_button ) . '">' . esc_html( $label_button ) . '</a>' ) );
			}
